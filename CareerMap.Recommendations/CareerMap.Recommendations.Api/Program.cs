...
// Registra o serviço de integração com a API Java
builder.Services.AddScoped<ITrilhaService, TrilhaService>();

// Configura o HttpClient para a API Java
builder.Services.AddHttpClient("JavaApi", client =>
{
    client.BaseAddress = new Uri(builder.Configuration.GetSection("JavaApi:BaseUrl").Value!);
});
